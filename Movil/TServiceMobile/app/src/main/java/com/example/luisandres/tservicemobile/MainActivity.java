...
public class MainActivity extends ActionBarActivity implements OnClickListener,OnItemSelectedListener, AdapterView.OnItemClickListener {
            ...
            if(choose) {
                ...
                try {
                    ...
                    if (isPostulante) {
                        ...
                        tipo="Publicante";
                        json.put("fechaUltimaLicecia",JSONObject.NULL);
                ...
                Connection con = new Connection(tipo);

                con.execute(json);

                System.out.println("Crear dialogo de alerta !!");
